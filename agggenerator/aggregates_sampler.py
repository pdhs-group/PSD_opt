...
from material_mix import (
    MaterialMixParams,
    MASPhysicalParams,
    assign_materials_with_target_mas,
)
# GridFactory lives in lmcann.core.grid; adjust the import path if needed.
from lmcann.core import GridFactory  # :contentReference[oaicite:1]{index=1}
