...
from pbe_core.func.bind_methods import bind_methods_from_module
from .opt_base_ray import OptBaseRay
from pbe_core.func.print import print_highlighted
## For plots
...
bind_methods_from_module(OptBase, 'pbe_optimizer.optimizer.opt_base_ray')
